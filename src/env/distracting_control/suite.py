...
def load(
    ...
    ), f"intensity must be in the [0,1] interval"
    assert (
        str(difficulty) in suite_utils.DIFFICULTY_NUM_VIDEOS.keys()
    ...
    if difficulty and background_on:
